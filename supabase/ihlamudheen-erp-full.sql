...
--  Adds NEW tables only (students, classes, student_attendance, exams, grades,
--  teachers, staff_attendance, payments, fees, timetables, fest, …). Does NOT
--  touch your accounting tables (attendance=staff, staff, categories, funds,
--  transactions, profiles).
--
--  HOW TO RUN: Supabase Dashboard -> SQL Editor -> New query -> paste ALL ->
--  Run. Re-runnable (IF NOT EXISTS). If a statement errors, send me the error.
-- ============================================================================
