...
function buildEmailHtml(
  ...
  return [
    ...
    '    <p style="font-size: 15px; color: #4a5568; margin: 0 0 20px; line-height: 1.7;">This is to inform you that your <strong>' + typeLabel + '</strong> for the month of <strong>' + monthLabel + '</strong> amounting to <strong style="color: #1a7a4a; font-size: 16px;">' + amount + ' INR</strong> has been successfully processed and paid.</p>',
    ...
    '        <tr><td style="padding: 4px 0; color: #718096;">Amount</td><td style="padding: 4px 0; font-weight: bold; text-align: right; color: #1a7a4a;">' + amount + ' INR</td></tr>',
